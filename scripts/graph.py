...
filepath_new = os.path.join(root_dir, 'data', 'graph', 'graph_connections_filtered.csv')
data = open(filepath_new, "r")
...
def calculate_metrics():
    ...
    print(f"Unweighted path length: {average_path_length_unweighted}")
